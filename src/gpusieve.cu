...
#define GPUSIEVE_THREADS_PER_BLOCK 256
...
const uint32 threadsPerBlock     = GPUSIEVE_THREADS_PER_BLOCK;   // Threads per block
#ifdef MORE_CLASSES
...
__global__ static void __launch_bounds__(GPUSIEVE_THREADS_PER_BLOCK, MIN_BLOCKS_PER_MP)
...
__global__ static void __launch_bounds__(GPUSIEVE_THREADS_PER_BLOCK, MIN_BLOCKS_PER_MP) CalcModularInverses(uint32 exponent, int *calc_info)
{
